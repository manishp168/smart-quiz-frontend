...
const GlassIcon = ({ item, className }) => {
  ...
  return (
    <button
      type="button"
      className={`relative bg-transparent outline-none w-[3em] h-[3em] [perspective:20em] [transform-style:preserve-3d] [-webkit-tap-highlight-color:transparent] group ${
        item.customClass || ""
      }`}
    >
      <span
